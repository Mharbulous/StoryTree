...
STATUS_COLORS = {
    ...
    'conflicted': '#D25B00',   # RGB(210, 91, 0) - dark orange
    'blocked': '#DB7100',      # RGB(219, 113, 0) - orange
    'escalated': '#E28B00',    # RGB(226, 139, 0) - golden orange
...
HOLD_ICONS = {
    ...
    'conflicted': '⚔',   # Conflicted - overlaps scope in inconsistent way
    'wishlisted': '💭',  # Wishlisted - indefinite hold, maybe someday
}
